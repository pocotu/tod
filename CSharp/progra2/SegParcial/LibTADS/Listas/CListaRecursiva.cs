    ...
    public class CListaRecursiva : ILista
    {
        ...
        public object Iesimo(int posicion)
        {
            if (posicion < 1 || posicion > Longitud())
            {
                ...
                // Si la posicion es incorrecta, muestra un mensaje de error y devuelve null
                return null; 
            }

            // Obtiene el elemento en la posicion especificada de forma recursiva
        ...
        public void Insertar(object elemento, int posicion)
        {
            ...
            // Inserta un elemento en la posicion especificada de forma recursiva
        ...
        {
            if (nodo == null)
                return -1; // Caso base: el nodo es nulo, el elemento no esta en la lista
