...
def Diferenciassim(LF,LB):
    return Union(Diferencia(LF, LB),Diferencia(LB, LF))
...
# -- Determinar los deportistas que juegan solo en futbol
LResultado=Diferencia(LFutbol, LBasket)
EscribirDeportistas('solo en futbol', LResultado)
LResultado=Diferenciassim(LFutbol, LBasket)
EscribirDeportistas('dif simetrica', LResultado)
