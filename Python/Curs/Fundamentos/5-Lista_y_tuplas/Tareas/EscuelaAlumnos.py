...
def AlumnosIngresantes(LA):
    ...
    for A in LA:
        ...
        if A[0].startswith(Anio[2:]):
            print(A)
#------modulo de alumunos ingresantes escuela lista
def AlumnosIngresantesEscuela(LE,LA):
    Anio=input('año de ingreso: ')
    codigo=input('codigo de la escuela: ')
    for i in LA:
        if i[0].startswith(Anio[2:]) and i[4]==codigo:
            print(i9
...
while Opcion !=13:
    ...
    if Opcion == 1:
        ...
        AlumnosIngresantesEscuela(ListaE,ListaA)
