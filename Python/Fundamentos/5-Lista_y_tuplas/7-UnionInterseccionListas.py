...
# -----------  Diferencia  -------------
def Diferencia(LF, LB):
    # Quitar los deportistas de basket en deportista futbol
    for DB in LB:
        while DB in LF:
            LF.remove(DB)
    # -- Devolver Lista futbol
    return LF

# -----------  Diferencia  simétrica -------------
def DiferenciaSimetrica(LF, LB):
    # -- Inicializar la lista resultado    
    LR = []
    # -- Ubicar los deportistas de fútbol en la lista de los deportistas de basket
    for DF in LF:
...
# -- Determinar la diferencia entre lista futbol con lista basket
LResultado = Diferencia(LFutbol, LBasket)
# -- Mostrar la diferencia total
EscribirDeportistas('Diferencia de LF y LB', LResultado)

# -- Determinar la diferencia simetrica
LResultado = DiferenciaSimetrica(LFutbol, LBasket)
# -- Mostrar la diferencia simetrica total
EscribirDeportistas('Diferencia simetrica', LResultado)