...
# texture
texture = pg.image.load('D:/Algo/Win/tod/Python/Scripts/MiniProblemas/Mandelbrot-set-Realtime-Viewer--main/Mandelbrot-set-Realtime-Viewer--main/img/texture.jpg')
