...
faces_img_folder = ("D:/Algo/Win/tod/Python/Py para no mate/Recocimiento facial/otros/Project of face recognition/faces image")
test_img = cv2.imread(r"D:/Algo/Win/tod/Python/Py para no mate/Recocimiento facial/otros/Project of face recognition/test img/test img/TogetherWrong.jpeg")
